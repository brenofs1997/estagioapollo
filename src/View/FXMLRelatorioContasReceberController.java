 ...
 * @author paulo
 */
public class FXMLRelatorioContasReceberController implements Initializable {
...
//
    ...
    private void Consultar(ActionEvent event) {
        ...
        String sql = "select ct.nome,cr.parcela,cr.valor,cr.valor_pago,cr.emissao,cr.valor-cr.valor_pago as valor_restante"
                ...
                + " and cp.descricao not like '%Fiado%'";
        ...
        if (gerarRelatorio(sql, "src/relatorios/RelContasReceber.jasper", "Lista de Contas a Receber") == false) {
            gerarRelatorio(sql, "relatorios/RelContasReceber.jasper", "Lista de Contas a Receber");
        }
    }
    ...
    private void Ajuda(ActionEvent event) {
        Ajuda a = new Ajuda();
        a.Ajuda("RelatoriodeContasReceber.htm");
    }
